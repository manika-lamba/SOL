...
-   The orientation to the online environment started with the 13th
    edition (1986) -15th edition is considered to be a innovative era of
...
-   There are some changes has been seen in 15th edition like adoption
    ...
    SA instead of X,XX etc. It gave every page a new look
...
-   It means that subject should be entered under its most specific
    heading, not under the class to which it belongs. For example
...
-   If the word is more than one spelling, then the most popular one
    chosen for common usage. For example
...
A)  [**Non-preferred headings**]{style="color: blue;"}: These headings
    are those which are not to be used. Such headings are given in light
    type face print. Each such non-preferred heading is invariably
    preceded by given a lead
:::
...
B)  [**Preferred headings**]{style="color: blue;"}: They are authorized
    term represented in a bold face for use against the document content
