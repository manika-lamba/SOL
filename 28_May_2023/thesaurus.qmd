...
-   [Efficiency of an IR system depends on the indexing language
    used]{style="color: blue;"}

-   Its capability to [handle 2 fundamentally different but
    interdependent types of relationship between the
    terms]{style="color: blue;"} used to represent the subject content
    of the document

-   Thesaurus has mainly been conceived in the context of
    [post-coordinate indexing system]{style="color: blue;"} but it can
    be used for pre-coordinated system as well

-   The word 'Thesaurus' is of Greek origin, literally meaning
    [*treasury or storehouse of knowledge*]{style="color: blue;"}
...
among these elements]{style="color: blue;"}, provided that the following
criteria hold:

(i) the list contains a [significant proportion of non-preferred terms
    and/or of preferred terms not used as
    descriptors]{style="color: blue;"};
...
| Year           | Event                                 |
+================+=======================================+
| 1959           | Engineering Information Center of E.  |
|                | I. Dupont de Nemours developed the    |
|                | [first true thesaurus]{.underline}    |
+----------------+---------------------------------------+
| 1960           | Armed Services Technical Information  |
|                | Agency (ASTIA) produced the           |
|                | [Thesaurus of ASTIA                   |
...
+----------------+---------------------------------------+
| 1964           | Engineers Joint Council (EJC)         |
|                | published the [Thesaurus of           |
|                | Engineering Terms]{.underline}        |
+----------------+---------------------------------------+
...
|                | [first set of guidelines for          |
|                | thesaurus construction]{.underline}   |
+----------------+---------------------------------------+
...
+---------------+-----------------------------+
| 1974          | *First international        |
|               | standard for thesaurus      |
|               | construction* -- [ISO       |
|               | 2788]{.underline}           |
+---------------+-----------------------------+
...
-   To [provide a map]{style="color: blue;"} for a given field of
    knowledge indicating [how the concepts of ideas are related to each
    other]{style="color: blue;"}, which helps the indexer and searcher
    to [understand the structure of the field of
    knowledge]{style="color: blue;"}

-   To provide a [standard vocabulary]{style="color: blue;"} for a given
    subject

-   It provides [consistent representation]{style="color: blue;"} of the
    subject matter avoiding subject dispersion in output & input by
    [controlling synonyms, quasi-synonyms, &
    homographs]{style="color: blue;"}

-   [Bringing together the term which are semantically
    related]{style="color: blue;"}

-   To [limit the no. of term that assign to be a
...
::: columns
::: {.column width="50%"}
-   Its purpose is to [promote consistency in the
    indexing]{style="color: blue;"} of documents predominantly for
    post-coordinated ISAR

-   To facilitate [searching by linking entry terms with
    descriptors]{style="color: blue;"}
...
| names of subjects usually   | arranged in a helpful       |
| arranged in alphabetical    | order]{.underline}.         |
| order]{.underline}          |                             |
|                             | In other words, it is a     |
|                             | [compilation of all isolate |
|                             | ideas]{.underline} that     |
|                             | occur within a subject or   |
|                             | group of subjects arranged  |
|                             | in [alphabetical            |
|                             | order]{.underline}          |
+-----------------------------+-----------------------------+
...
| LSH                         | Thesaurus                   |
+=============================+=============================+
| LSH were designed in view   | Thesaurus was designed to   |
| the needs of                | meet the special needs of   |
| [pre-coordinate             | the [post-coordinate        |
| indexe]{.underline}s        | indexes]{.underline}        |
+-----------------------------+-----------------------------+
| In LSH, the [emphasis is on | Thesauri have more          |
| references from broader to  | [elaborate network of       |
| narrower                    | referencing,]{.underline}   |
| subject]{.underline} or     | the direction of each type  |
| downward references         | of reference is clearly     |
|                             | indicated                   |
+-----------------------------+-----------------------------+
...
-   It is the [relationship between preferred & non-preferred terms]{style="color: blue;"} where
    2 or more terms are regarded for indexing purposes as referring to
    the same concept

-   It is denoted by [USE and UF]{style="color: blue;"}
...
-   This [relationship shows level of super-ordination and sub-ordination]{style="color: blue;"}

-   It is used in [locating broader and narrower concepts in a logically
    progressive sequence]{style="color: blue;"}

-   The [relationship is reciprocal]{style="color: blue;"} and is set out in a thesaurus using
    following conventions:

    -   [**BT**(BROADER TERM)]{style="color: blue;"}
    -   [**NT**(NARROWER TERM)]{style="color: blue;"}

-   It includes [*generic relationship, hierarchical whole-part
    relationship, instance relationship, & polyhierarchical
    relationship*]{style="color: blue;"}
...
-   It identifies the [link between a class or category and its members
    or species]{style="color: blue;"}

-   It is also known as [Inclusion Relationship]{style="color: blue;"}
...
-   This relationship is between a [general category of things and events, expressed by a common noun]{style="color: blue;"}, and an [individual instance]{style="color: blue;"} of
...
-   It is the relationship between the [term & its 2 or more
    super-ordinate terms]{style="color: blue;"}

-   Some terms may belong to more than [one hierarchy]{style="color: blue;"} and consequently
    maybe related to [more than one broader term & more than one set of
    narrower terms]{style="color: blue;"}
...
-   This relationship is found between [terms which are closely related
    ...
    equivalence set]{style="color: blue;"}

-   The [relation is reciprocal]{style="color: blue;"}, and is distinguished by the abbreviation
    ["RT" (Related Terms)]{style="color: blue;"}
...
-   It [effects vocabulary control]{style="color: blue;"} in the language being used in IR
-   It helps an indexer in [selecting preferred terms]{style="color: blue;"}
-   It provides [more access points]{style="color: blue;"}
-   It enables the searcher to find out not only information on a
    [specific topic]{style="color: blue;"}, but also, on [all related topics]{style="color: blue;"}
-   By [using indexing terms and search terms from the same thesaurus,
    the speed of retrieval can be increased]{style="color: blue;"}
-   It helps in obtaining [high recall ratio & high precision ratio]{style="color: blue;"} in
    information search
